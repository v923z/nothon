...
function coloured_latex(line, pos) {
	...
	latex_commands = ['\\above', '\\abovewithdelims', 
	'\\aleph', '\\alpha', '\\amalg', '\\And', '\\angle', '\\approx', 
	'\\approxeq', '\\arccos', '\\arcsin', '\\arctan', '\\arg', '\\array', 
	'\\Arrowvert', '\\arrowvert', '\\ast', '\\asymp', '\\atop', '\\atopwithdelims', 
	'\\backepsilon', '\\backprime', '\\backsim', '\\backsimeq', '\\backslash', 
	'\\bar', '\\barwedge', '\\Bbb', '\\Bbbk', '\\bbox', '\\bcancel', '\\because', 
	'\\beta', '\\beth', '\\between', '\\bf', '\\Big', 
	'\\big', '\\bigcap', '\\bigcirc', '\\bigcup', '\\Bigg', '\\bigg', '\\Biggl', 
	'\\biggl', '\\Biggm', '\\biggm', '\\Biggr', '\\biggr', '\\Bigl', '\\bigl', 
	'\\Bigm', '\\bigm', '\\bigodot', '\\bigoplus', '\\bigotimes', '\\Bigr', 
	'\\bigr', '\\bigsqcup', '\\bigstar', '\\bigtriangledown', '\\bigtriangleup', 
	...
	'\\bumpeq', '\\cal', '\\cancel', '\\cancelto', '\\cap', '\\Cap', '\\cases', 
	...
	'\\color', '\\colorbox', '\\complement', '\\cong', '\\coprod', '\\cos', '\\cosh', 
	...
	'\\DefineColor', '\\def', '\\deg', '\\Delta', '\\delta', '\\det', '\\dfrac', 
	...
	'\\otimes', '\\over', '\\overbrace', '\\overleftarrow', '\\overleftrightarrow', '\\overline', 
	'\\overrightarrow', '\\overset', '\\overwithdelims', '\\owns', '\\parallel', '\\partial', 
	...
	'\\underline', '\\underrightarrow', '\\underset', '\\unicode', '\\unlhd', '\\unrhd', '\\Uparrow', 
